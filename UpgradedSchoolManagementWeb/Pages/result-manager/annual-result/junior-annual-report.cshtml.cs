...
namespace UpgradedSchoolManagementWeb.Pages.result_manager.annual_result
{
    ...
    public class junior_annual_reportModel : AnnualReportPageBaseModel
    {
        public junior_annual_reportModel(AnnualReportService annualReportService, ApplicationDbContext db)
