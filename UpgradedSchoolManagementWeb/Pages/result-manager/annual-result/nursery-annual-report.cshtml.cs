...
namespace UpgradedSchoolManagementWeb.Pages.result_manager.annual_result
{
    ...
    public class nursery_annual_reportModel : AnnualReportPageBaseModel
    {
        public nursery_annual_reportModel(AnnualReportService annualReportService, ApplicationDbContext db)
